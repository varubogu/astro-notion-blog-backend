/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: d2a30d969a098f34178d6da5e67184ea)
// Runtime types generated with workerd@1.20260114.0 2026-01-11
declare namespace Cloudflare {
	...
	interface Env {
		 ...
		 * NotionブログのデータソースID
		 */
		NOTION_DATASOURCE_POSTS_ID: string;
		/**
		 * NotionコメントのデータソースID
		 */
		NOTION_DATASOURCE_COMMENTS_ID: string;
		/**
		 * astro-notion-blog のURL（https://example.com など）
		 */
		MAINSITE_URL: string;
	}
}
